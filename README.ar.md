...
- **الأنماط** — أكثر من 50 مدخلاً في 9 فئات: إنشائية، هيكلية، سلوكية، تزامن، مزامنة، رسائل، استقرار، تحليل الأداء، تعابير اصطلاحية، أنماط مضادة. انظر [PATTERNS.md](PATTERNS.md).
- **الأمثلة** — 23 حزمة Go قابلة للتشغيل مع `_test.go`. وحدة مشتركة واحدة ضمن [`examples/`](examples/).
