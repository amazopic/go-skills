...
description: Producer Consumer — stub. Catalog placeholder; body to be filled in a later iteration. See SUMMARY at https://github.com/tmrts/go-patterns and go-patterns-2 archive for source material.
...
> - `go-old-pattern/go-patterns-2/<Concurrency>/<ProducerConsumer>/` (if present — runnable code + README)
