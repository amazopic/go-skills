...
description: Observer pattern in Go — a one-to-many publish/notify relationship with explicit Subject and Observer interfaces. Use when modeling subscription-style updates.
category: behavioral
go-version-min: "1.18"
sources:
  - go-old-pattern/go-patterns-1/behavioral/observer.md
example: examples/behavioral/observer/
---
