...
description: Chain of Responsibility — stub. Catalog placeholder; body to be filled in a later iteration. See SUMMARY at https://github.com/tmrts/go-patterns and go-patterns-2 archive for source material.
category: behavioral
status: stub
---
...
> - `go-old-pattern/go-patterns-2/Behavioral/ChainOfResponsibility/` (if present — runnable code + README)
...
> **Existing example:** see `examples/behavioral/chain-of-responsibility/`
