...
description: Strategy pattern — interchangeable algorithms behind a common interface, swapped at runtime. Use when an operation has multiple implementations selected by configuration.
category: behavioral
go-version-min: "1.18"
sources:
  - go-old-pattern/go-patterns-1/behavioral/strategy.md
example: examples/behavioral/strategy/
---
