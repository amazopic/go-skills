...
description: Prototype — stub. Catalog placeholder; body to be filled in a later iteration. See SUMMARY at https://github.com/tmrts/go-patterns and go-patterns-2 archive for source material.
category: creational
status: stub
---
...
> - `go-old-pattern/go-patterns-2/Creational/Prototype/` (if present — runnable code + README)
...
> **Existing example:** see `examples/creational/prototype/`
