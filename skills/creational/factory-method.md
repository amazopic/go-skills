---
name: creational-factory-method
description: Factory Method — defer instantiation to a function so the caller picks the variant. Use to abstract concrete-type selection behind a constructor.
category: creational
go-version-min: "1.18"
sources:
  - go-old-pattern/go-patterns-1/creational/factory.md
example: examples/creational/factory-method/
---
