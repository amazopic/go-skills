...
description: Steady-State — stub. Catalog placeholder; body to be filled in a later iteration. See SUMMARY at https://github.com/tmrts/go-patterns and go-patterns-2 archive for source material.
category: stability
status: stub
---
...
> - `go-old-pattern/go-patterns-2/<Stability>/<SteadyState>/` (if present — runnable code + README)
