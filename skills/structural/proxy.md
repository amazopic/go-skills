...
description: Proxy — interpose a stand-in object that controls access to the real one (lazy load, access control, remote call). Use for transparent delegation.
category: structural
go-version-min: "1.18"
sources:
  - go-old-pattern/go-patterns-1/structural/proxy.md
example: examples/structural/proxy/
---
